...
| P02 | IP/DTN boundary | S030 gateway executes GX-A1/SQLite/HMAC fault semantics around bidirectional dtn7-go/bp7-rs wire exchange; external run pending | Full daemon/convergence-layer session, BPSec profile, contact routing and application receipt |
