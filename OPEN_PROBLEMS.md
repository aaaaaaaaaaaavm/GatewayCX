...
| P02 | IP/DTN boundary | S030 run 33294426808 proves one exact dtn7-go → bp7-rs crossing through GX-A1/SQLite/HMAC faults and records reciprocal `EOF` rejection | Bidirectional external acceptance, full daemon/convergence-layer session, BPSec profile, contact routing and application receipt |
