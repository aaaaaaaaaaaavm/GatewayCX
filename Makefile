.PHONY: scenarios disruption capacity placement admission handover updates preposition black-start diagnostics integrated adapters durable transport authenticated abrupt independent orbits offload ephemeris links datacentre economics figures conformance audit test verify
