.PHONY: scenarios disruption capacity placement admission handover updates preposition black-start diagnostics conformance audit test verify
...
verify: scenarios disruption capacity placement admission handover updates preposition black-start diagnostics conformance audit test
	git diff --exit-code -- results/baseline.json results/S005_disruption.json results/S006_capacity_envelope.json results/S007_service_placement.json results/S009_admission.json results/S010_handover.json results/S011_update_delivery.json results/S012_prepositioning.json results/S013_black_start.json results/S014_diagnostic_trace.json profiles/diagnostics/gx-o1-fault-codes.json
